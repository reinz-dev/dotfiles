...
alias kittyrc='nv ~/.config/kitty/kitty.conf'
...
alias getupdate='sudo apt-get update && sudo apt-get upgrade'
alias aptinstall='sudo apt install'
alias getinstall='sudo apt-get install'
alias aptuninstall='sudo apt uninstall'
alias getuninstall='sudo apt-get uninstall'
...
##======| Backup Dotfiles |======##
# copy config in dotfiles
alias copy-dotfiles='mkdir ~/.dotfiles-reinz && mkdir ~/.dotfiles-reinz/.config && cp -rf ~/.config/fish/ ~/.config/nvim/ ~/.config/kitty/ ~/.config/neofetch/ ~/.config/ranger/ ~/.config/starship.toml ~/.dotfiles-reinz/.config/ && cp -rf ~/.repo/ ~/.icons/ ~/.tmux/ ~/.tmux.conf ~/.fonts/ ~/.pywal/ ~/.themes/ ~/.dotfiles-reinz/ --force && echo "Success Copied" '
# delete all dotfiles
alias del-dotfiles='sudo rm -rf ~/.dotfiles-reinz/ && echo "Success Delete" '
# paste all dotfiles after clean install
alias restore-dotfiles='cp -rf ~/.dotfiles-reinz/ ~ --force && echo "Success Restore" '


##======| Restore Nvim Config |======##
alias install-nvim='git clone https://github.com/reinzcity/nvim.git ~/.config/'
alias install-packer='git clone https://github.com/wbthomason/packer.nvim ~/.local/share/nvim/site/pack/packer/start/packer.nvim'
